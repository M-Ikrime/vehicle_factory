...
namespace UretimTakip
{
    public partial class ViewCars : Form
    {
        ...
        private void Update()
        {
            ...
            if (cmb_status.Text == "Satıldı") vehicle.IsSold = IsSold.Satıldı;
            else vehicle.IsSold = IsSold.Satılmadı;
        ...
        private void TUMUNU_ARA()
        {
            ...
            dataGridView1.Columns[10].Width = 75; //TypeId
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                if (dataGridView1.Rows[i].Cells[8].Value.ToString().Trim() == "1")
                {
                    dataGridView1.Rows[i].DefaultCellStyle.BackColor = Color.Green;
                }
                else if (dataGridView1.Rows[i].Cells[8].Value.ToString().Trim() == "0")
                {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.CurrentRow.Cells["IsSold"].Value.ToString() == "0") cmb_status.Text = "Satılmadı";
            else cmb_status.Text = "Satıldı";
        ...
        private void ViewCars_Load(object sender, EventArgs e)
        {
            ...
            cmb_status.Items.Add(IsSold.Satıldı);
            cmb_status.Items.Add(IsSold.Satılmadı);

            //if (dataGridView1.CurrentRow.Cells[9].Value.ToString() == IsSold.Satılmadı.ToString()) dataGridView1.CurrentRow.Cells[9].Value. = "Satılmadı";
            //else dataGridView1.CurrentRow.Cells[9].Value = "Satılmadı";
